...
import (
	...
	"github.com/Pranaenae/lets-go/internal/validator"
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MaxChars(form.Title, 100), "title", "This field cannot exceed 100 characters in length")
